...
import officials from '../assets/json/instructors.json';


type ImageItem = string | { src: string; name?: string };
...
const activeOfficials = [...officials]
    .filter(off => off.status === 'A' && off.sid === 1)
...
export default function DomeGallery({
  images = activeOfficials,
  fit = 0.5,
  fitBasis = 'auto',
  minRadius = 600,
  maxRadius = Infinity,
  padFactor = 0.25,
  overlayBlurColor = 'var(--bg-raised)',
